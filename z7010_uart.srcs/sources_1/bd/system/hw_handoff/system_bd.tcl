...
proc create_root_design { parentCell } {
  ...
  set AXI_GPIO0_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 AXI_GPIO0_0 ]
  set AXI_GPIO0_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 AXI_GPIO0_1 ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports AXI_GPIO0_0] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports AXI_GPIO0_1] [get_bd_intf_pins axi_gpio_0/GPIO2]
